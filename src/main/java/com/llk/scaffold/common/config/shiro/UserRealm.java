...
import com.llk.scaffold.dao.UserDao;
...
public class UserRealm  extends AuthorizingRealm {
    ...
    private final RoleDao roleMapper;
    private final PermissionDao permissionMapper;

    @Autowired
    public UserRealm(UserDao userMapper, RoleDao roleMapper, PermissionDao permissionMapper) {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        String account = JwtUtil.getClaim(principalCollection.toString(), JwtUtil.ACCOUNT);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        if (JwtUtil.verify(token) && RedisUtil.hasKey(RedisUtil.getTokenKey(account))) {
            // 获取RefreshToken的时间戳
            String currentTimeMillisRedis = RedisUtil.get(RedisUtil.getTokenKey(account)).toString();
